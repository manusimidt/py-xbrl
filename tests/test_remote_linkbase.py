...
from xbrl.linkbase import parse_linkbase_url, LinkbaseType, Linkbase, Locator, Label
...
class RemoteLinkbaseTest(unittest.TestCase):
    ...
    def test_parse_linkbase_url(self):
        ...
        linkbase_url: str = (
            "https://www.esma.europa.eu/taxonomy/2019-03-27/esef_cor-lab-de.xml"
        )
        ...
        assets_locator: Locator = next(
            filter(
                lambda x: x.name == "Assets", linkbase.extended_links[0].root_locators
            )
        )
